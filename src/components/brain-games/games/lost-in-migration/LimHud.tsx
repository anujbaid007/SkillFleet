...
import type { LimHudDetail } from './LostInMigrationEngine';

/** Time, score and streak, with the standing reminder along the horizon. */
export function LimHud({ hud, displayScore, onPause }: GameHudProps) {
  const detail = hud.detail as LimHudDetail | undefined;
  ...
  return (
    <HudFrame
      ...
      bottom={<div className="lim-hint">Swipe in the direction of the middle bird</div>}
    />
  );
}
